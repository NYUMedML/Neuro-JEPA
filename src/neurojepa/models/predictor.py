...
from neurojepa.utils.tensors import repeat_interleave_batch, trunc_normal_
...
class VisionTransformerPredictor(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # --
        self.grid_height = img_size[0] // self.patch_size[0]
        self.grid_width = img_size[1] // self.patch_size[1]
        self.grid_depth = img_size[2] // self.patch_size[2]
    ...
    def _init_pos_embed(self, pos_embed):
        ...
        grid_size = self.img_height // self.patch_size[0]  # TODO: update; currently assumes square input
        grid_depth = self.img_depth // self.patch_size[2]
    ...
    def forward(self, x, masks_x, masks_y, mask_index=1, has_cls=False):
        ...
        for i, blk in enumerate(self.predictor_blocks):
            if self.use_activation_checkpointing:
                x, _ = torch.utils.checkpoint.checkpoint(blk, x, masks, None, use_reentrant=False)
            else:
                x, _ = blk(x, mask=masks, attn_mask=None)
